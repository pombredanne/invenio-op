...
from invenio.modules.formatter.engines.bfs_config import CFG_BIBFORMAT_BFX_LABEL_DEFINITIONS, CFG_BIBFORMAT_BFX_TEMPLATES_PATH
from invenio.modules.formatter.engines.bfs_config import CFG_BIBFORMAT_BFX_FORMAT_TEMPLATE_EXTENSION, CFG_BIBFORMAT_BFX_ELEMENT_NAMESPACE
from invenio.modules.formatter.engines.bfs_config import InvenioBibFormatBfxError, InvenioBibFormatBfxWarning
...
def copy(old_record, address=''):
    ...
    @param address: an address; for examples see modules.formatter.engines.bfs_config.
