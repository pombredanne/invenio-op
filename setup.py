...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'webcoll = invenio.modules.search.scripts.webcoll:main',
            'bibsort = invenio.modules.sort.scripts.bibsort:main',
            'bibupload = invenio.modules.upload.scripts.bibupload:main',
        ],
    },
